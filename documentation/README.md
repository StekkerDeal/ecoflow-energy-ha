...
- [STREAM AC 5000](entities/stream-ac-5000.md) - 52 sensors, 1 binary sensor, 4 numbers, 1 select (`ES22`) - shares the Stream name but not the Stream protocol, so it has its own parser and entity set
