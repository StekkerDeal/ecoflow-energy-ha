...
| **STREAM AC 5000** - AC-coupled Battery | `ES22`\* | 52 + 1 binary | 4 numbers, 1 select (Enhanced only) | 4 default (grid import/export, battery charge/discharge), 2 optional diagnostic (home, solar) | ~2 s enhanced |
